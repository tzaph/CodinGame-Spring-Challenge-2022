/*
League: Silver 400/6000 (5th day)
Spells used: All spells
Tactic: Sky Arrow V3
Simply one defender, one farmer, and one attacker. Details of individual roles can be seen in other code
Optimizsed Farmer and Attacker:
- Attacker controls spiders to more directions
- Attack pulls opponent defense using control spell
*/
